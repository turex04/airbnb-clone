...
export default function InfoCard({ result }) {
  ...
  return (
    <div
      className="flex flex-row py-7 px-2 border-b cursor-pointer hover:opacity-90
    hover:shadow-lg pr-4 transition duration-200 ease-out transform first:border-t "
    >
